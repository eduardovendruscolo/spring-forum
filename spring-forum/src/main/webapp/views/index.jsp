...
<div class="row">
	...
	<div class="eight columns">
		...
		<p>
			O projeto Spring F&oacute;rum &eacute; um gerenciador de comunidades
			virtuais (a la GUJ) baseado nos conceitos apresentados no livro <i>Virando
				o Jogo com Spring Framework</i> de <i>Henrique Lobo Weissmann</i>.
		</p>
		<p>Seu c&oacute;digo fonte &eacute; totalmente aberto e voc&ecirc;
			&eacute; livre para explor&aacute;-lo da maneira que achar melhor.</p>
	</div>
	<div class="two columns">
...
<div class="row">
	...
	<div class="six columns">
		<input type="submit" value="zuera" class="tiny button success" />
	</div>
</div>
